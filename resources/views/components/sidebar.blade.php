...
<div class="sidebar bg-black"> 
    <ul class="sidebar-list" style="padding: 0">
        ...
        <a onclick="enableSidebar(2)" href=""><li class="color-grey m-0 py-3 px-4 sidebar-item-2">Membros</li></a>
        <a onclick="enableSidebar(3)" href=""><li class="color-grey m-0 py-3 px-4 sidebar-item-3">Equipes</li></a>
        <a onclick="enableSidebar(4)" href="/events"><li class="color-light m-0 py-3 px-4 sidebar-item-4">Eventos</li></a>
        <a onclick="enableSidebar(5)" href=""><li class="color-grey m-0 py-3 px-4 sidebar-item-5">Categorias</li></a>
        <a onclick="enableSidebar(6)" href=""><li class="color-grey m-0 py-3 px-4 sidebar-item-6">Regras</li></a>
        <a onclick="enableSidebar(7)" href=""><li class="color-grey m-0 py-3 px-4 sidebar-item-7">Emblemas</li></a>
        <a onclick="enableSidebar(8)" href=""><li class="color-grey m-0 py-3 px-4 sidebar-item-8">Temporadas</li></a>
    </ul>    
</div> 
